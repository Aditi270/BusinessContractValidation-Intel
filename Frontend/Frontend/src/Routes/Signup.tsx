    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <main className="flex-1 py-16 flex items-center justify-center">
        <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-lg shadow-xl w-full max-w-md">
          <h2 className="text-3xl font-bold mb-6 text-center bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-yellow-300">Create a new account</h2>
          <form>
            <div className="mb-4">
              <label htmlFor="name" className="block text-orange-200 mb-2">Name</label>
              <input
                type="text"
                id="name"
            ...
            <div className="mb-6">
              <label htmlFor="confirm-password" className="block text-orange-200 mb-2">Confirm Password</label>
              <input
                type="password"
                id="confirm-password"
                className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 text-white"
